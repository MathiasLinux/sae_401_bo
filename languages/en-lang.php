...
const LEGAL_NOTICE_P_3 = "The Site is hosted by OVH, a company with a capital of 10,059,500 euros, registered with the Lille Métropole Trade and Companies Register under number 424 761 419 00045, whose head office is located at 2 rue Kellermann - 59100 Roubaix - France. The host\'s individual VAT number is: FR 22 424 761 419.";
...
const ADMIN_HOME_PAGE_CONTACT = "Contact Form";
const ADMIN_HOME_PAGE_RESERVATION = "Reservations";
const ADMIN_HOME_PAGE_GIFT_CARD = "Gift Cards";
...
const ADMIN_QANDA_MOD_CAT_EN = "Modify category";
const ADMIN_QANDA_MOD_CAT_FR = "Modify category FR";
const ADMIN_QANDA_MOD_CAT_SUBMIT = "Update category";
const ADMIN_QANDA_MOD_EG = "Modify assoc. EG";
